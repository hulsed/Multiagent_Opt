        ...
        for k=1:numKs
            ...
            % that to the found merit of each paremeter value taken.
             ...
             if conviolr < bestconviol(e) %&& all(constraints <= 0.01)
                 ...
                 if obj1r<bestobj(e)
                    reward_G=(bestobj(e)-obj1r)+conscale*(bestconviol(e)-conviolr);
                else
                    reward_G=conscale*(bestconviol(e)-conviolr);
                end
            ...
            if rewardstruct=='D'
              ...
              for ag=1:(length(intchoices)+length(UB))
                ...
                if conviolc < bestconviol(e) %&& all(constraints <= 0.01)
                 ...
                 if obj1c<bestobj(e)
                    reward_C=(bestobj(e)-obj1c)+conscale*(bestconviol(e)-conviolc);
                else
                    reward_C=conscale*(bestconviol(e)-conviolc);
                end
