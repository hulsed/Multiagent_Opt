function [rewards, G] = compute_rewards(useD, cell, battery, motor, prop, foil, avgCell, avgMotor, avgProp, avgFoil)
    ...
    if ~useD % if NOT using difference reward
        rewards = ones(10, 1) * G; % Just return G for all rewards
    else
        rewards = zeros(10, 1);
